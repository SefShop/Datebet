...
const C = {
  en: {
    ...
    h1: ["This isn't just a game.", "It's how you meet", 'someone.'],
  ...
  gr: {
    ...
    h1: ['Αυτό δεν είναι απλά ένα παιχνίδι.', 'Είναι ο τρόπος να γνωρίσεις', 'κάποιον.'],
...
export default function AuthScreen({ onAuth, lang = 'gr' }: Props) {
  const t = C[lang]
