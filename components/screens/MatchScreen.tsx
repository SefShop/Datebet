...
export default function MatchScreen() {
  ...
  return (
    <div className="flex flex-col h-full items-center justify-center px-8 relative overflow-hidden"
      style={{ background:'radial-gradient(ellipse at 50% 40%, rgba(253,41,123,0.354) 0%, transparent 60%), linear-gradient(170deg, #100a1a 0%, #0d0818 100%)' }}>

      {/* Glow */}
      <div className="absolute rounded-full" style={{
        width:300, height:300, top:'50%', left:'50%', transform:'translate(-50%,-58%)',
        background:'radial-gradient(circle, rgba(253,41,123,0.236) 0%, transparent 70%)',
      ...
      <div className="flex items-center gap-5 mb-8 relative z-10"
        ...
        <div className="w-24 h-24 rounded-full flex items-center justify-center text-[48px] overflow-hidden"
          style={{ background:'linear-gradient(135deg,#ff3384,#ff7a6e)', boxShadow:'0 8px 32px rgba(253,41,123,0.59)' }}>
          😎
        </div>
        ...
        <div className="w-24 h-24 rounded-full overflow-hidden"
          style={{ boxShadow:'0 8px 32px rgba(167,139,250,0.472)', border:'3px solid rgba(253,41,123,0.472)' }}>
      ...
      <p className="text-[14px] mb-2 relative z-10" style={{ color:'rgba(255,255,255,0.59)',
           animation: show ? 'fadeUp 0.5s 0.45s ease both' : 'none' }}>
        {match.name}, {match.age} — {match.location[lang]}
      </p>
      <p className="text-[13px] mb-10 relative z-10" style={{ color:'rgba(255,255,255,0.413)',
